...
% torque_fric_3 = current(friction_index(323:763))-friction(friction_index(323:763));
% torque_fric_3 = torque_fric_3 - mean(torque_fric_3);
% torque_fric_4 = current(friction_index(764:906))-friction(friction_index(764:906));
% torque_fric_5 = current(friction_index(907:end))-friction(friction_index(907:end));
% torque_fric_5 = torque_fric_5 - mean(torque_fric_5);
% torque_fric = [torque_fric_1,torque_fric_2,torque_fric_3,torque_fric_4,torque_fric_5];
