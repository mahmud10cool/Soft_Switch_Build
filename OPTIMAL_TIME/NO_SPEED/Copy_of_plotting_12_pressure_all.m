...
somethin = ["test_8","test_10","test_11","test_12","test_13","test_14","test_15","test_20"];
length_somethin = length(somethin);
file_name = ["8ms","10ms","11ms","12ms","13ms","14ms","15ms","20ms"];
...
adjustment = [0.11,0.11,0.127,0.11,0.11,0.127,0.11,0.127];
...
figure(3)
% hold on
switch_times = [8,10,11,12,13,14,15,20];
